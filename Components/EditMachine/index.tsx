...
import { updateMachine } from "@/lib/machine";
...
const EditMachine: FC<Props> = ({ machine }) => {
  ...
  const clickHandler = async () => {
    setLoading(true);
    const response = await updateMachine(machine._id, {
      name: machineState.name,
      platePrice: machineState.platePrice,
      makeReadyPrice: machineState.makeReadyPrice,
